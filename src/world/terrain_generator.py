...
from src.core.constants import (
	...
	WATER_HEIGHT_MAX, DESERT_MOISTURE_MAX, FOREST_MOISTURE_MIN,
...
def generate_moisture(width, height, seed):
	return noise_layer(width, height, seed + 1000, NOISE_SCALE_MOISTURE) * 100.0


def generate_precipitation(width, height, seed):
	return noise_layer(width, height, seed + 2000, NOISE_SCALE_PRECIPITATION) * 100.0
